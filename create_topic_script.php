...
include "includes/header.php";
    ...
    if(isset($_SESSION['id']) & $_GET['cat_id'] == 6) {
        ...
        $values = array(":subject"=>htmlspecialchars($_POST["subject"]), ":topic_date"=>$creationDate, ":topic_by"=>$_SESSION['id'], ":topic_cat"=>$_GET['cat_id'], ":topic_search"=> 1);
        ...
        $values2 = array(":content"=>htmlspecialchars($_POST["message"]), ":post_date"=>$creationDate, ":post_topic"=>$topicId, ":post_by"=>$_SESSION['id']);
        ...
        if(isset($_SESSION['id'])) {
            ...
            $values = array(":subject"=>htmlspecialchars($_POST["subject"]), ":topic_date"=>$creationDate, ":topic_by"=>$_SESSION['id'], ":topic_cat"=>$_GET['cat_id']);
